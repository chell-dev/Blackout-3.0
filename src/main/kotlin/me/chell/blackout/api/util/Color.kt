...
class Color(red: Float, green: Float, blue: Float, var alpha: Float = 1f, var rainbow: Boolean = false, sync: Boolean = false) {

    constructor(red: Int, green: Int, blue: Int, alpha: Int = 255): this(red / 255f, green / 255f, blue / 255f, alpha / 255f)
