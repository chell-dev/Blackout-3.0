...
enum class Category(val icon: Identifier) : Description {
    Combat(Identifier(modId, "textures/gui/categories/combat.png")) {
        override var description = "Combat"
    },
    Render(Identifier(modId, "textures/gui/categories/render.png")) {
        override var description = "Render"
    },
    PLayer(Identifier(modId, "textures/gui/categories/player.png")) {
        override var description = "Player"
    },
    Movement(Identifier(modId, "textures/gui/categories/movement.png")) {
        override var description = "Movement"
    },
    Misc(Identifier(modId, "textures/gui/categories/misc.png")) {
        override var description = "Misc"
    },
    Client(Identifier(modId, "textures/gui/categories/client.png")) {
        override var description = "Client"
    },
    Hud(Identifier(modId, "textures/gui/categories/hud.png")) {
        override var description = "HUD"
    }
}