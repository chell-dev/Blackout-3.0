            ...
            when (entity) {
                is PlayerEntity -> {
                    if (players.value) {
                        ...
                        if (entity.isFriend()) {
                            ...
                            if (friendsOutline.value.alpha > 0f) drawBoxOutline(
                                entity.renderBoundingBox,
                                friendsOutline.value,
                                1f
                            )
                        } else {
                            if (playersFill.value.alpha > 0f) drawBox(entity.renderBoundingBox, playersFill.value)
                            if (playersOutline.value.alpha > 0f) drawBoxOutline(
                                entity.renderBoundingBox,
                                playersOutline.value,
                                1f
                            )
                        }
                    }
                ...
                is ItemEntity -> {
                    if (items.value) {
                        ...
                        if (itemsOutline.value.alpha > 0f) drawBoxOutline(
                            entity.renderBoundingBox,
                            itemsOutline.value,
                            1f
                        )
                ...
                is EnderPearlEntity -> {
                    if (pearls.value) {
                        ...
                        if (pearlsOutline.value.alpha > 0f) drawBoxOutline(
                            entity.renderBoundingBox,
                            pearlsOutline.value,
                            1f
                        )
                ...
                is ExperienceBottleEntity -> {
                    if (xpBottles.value) {
                        ...
                        if (xpBottlesOutline.value.alpha > 0f) drawBoxOutline(
                            entity.renderBoundingBox,
                            xpBottlesOutline.value,
                            1f
                        )
                    }
                }
